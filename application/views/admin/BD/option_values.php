                        ...
                        <form action="#" method="post">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="button" href="<?php echo base_url().'admin/option_values/index/'.$selected_option_id;?>">Cancel</a>
                                </td>
                            </tr>
                        </form>
                    <?php }else{?>
                        <tr>
                            ...
                            <td>
                                <a class="button" href="<?php echo base_url().'admin/option_values/edit/'.$selected_option_id.'/'.$op->product_option_value_id;?>">Edit</a>
