...
<?php $this->load->view('public/'.get_language().'/search_view'); ?>
    ...
    <form action="<?php echo base_url() . "public/customer/change_address_book"; ?>" method="post">
        ...
        <fieldset>
        <legend> <span class="star">*</span></legend>
        <table
        <tr>
            <td>রোডের ঠিকানা<span class="star">*</span></td>
            <td>
        ...
        <tr>
            <td>পোস্ট <span class="star">*</span></td>
            <td>
        ...
        <tr>
            <td>শহর <span class="star">*</span></td>
            <td>
        ...
        <tr>
            <td>স্টেট <span class="star">*</span></td>
            <td>
        ...
        <tr>
        <td>দেশ <span class="star">*</span></td>
        <td>
        <select name="country">
